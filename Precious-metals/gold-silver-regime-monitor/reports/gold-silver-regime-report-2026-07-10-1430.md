# 黄金白银日度监控｜2026-07-10 14:30｜Asia/Shanghai
...
| 模块 | 得分 | 上限 | 状态 | 核心变化 |
|---|---:|---:|---|---|
| 宏观转向 | 5 | 40 | 中性/压制 | 10Y 实际利率 20D 10.0bp；美元 20D 1.09% |
| 资金流确认 | 0 | 0 | 未确认 | GLD/COT/WGC 未接入，按规则缩放总分 |
| 价格结构 | 5 | 30 | 中性/压制 | Gold vs MA20 4140.13 / MA50 4373.49 / MA100 4613.88 |
| 风险环境 | 0 | 10 | 中性/压制 | VIX 10D -3.05；HY OAS 20D -10.0bp |

## 关键数据
| 指标 | 最新值 | 5D | 10D | 20D | 解释 |
|---|---:|---:|---:|---:|---|
| Gold close | 4116.10 | 见历史库 | 见历史库 | 见历史库 | Yahoo:GC=F / 2026-07-10 |
| 10Y real yield | 2.31% | N/A | 2.0bp | 10.0bp | FRED DFII10 |
| Broad USD | 120.69 | N/A | 1.09% | 1.09% | FRED DTWEXBGS |
| 2Y yield / policy proxy | FRED DGS2 | N/A | N/A | 6.0bp | 隐含政策利率未接入，使用 2Y 降级代理 |
| 10Y breakeven | FRED T10YIE | N/A | N/A | -10.0bp | 通胀预期代理 |
| GLD holdings | UNAVAILABLE | UNAVAILABLE | UNAVAILABLE | UNAVAILABLE | MVP 未接入官方持仓 |
| VIX | FRED VIXCLS | N/A | -3.05 | N/A | 风险偏好代理 |
| HY OAS | FRED BAMLH0A0HYM2 | N/A | N/A | -10.0bp | 信用风险代理 |

## 白银伴随观察
- Silver close: 60.24（Yahoo:SI=F / 2026-07-10）
- Silver MA20 / MA50: 62.59 / 70.49
- Silver distance to MA50: -14.54%
...
- 数据质量：FAIL
- 叙事标签：NARRATIVE_ONLY
- 数据年龄：price 0 天；real yield 2 天；USD 8 天。
