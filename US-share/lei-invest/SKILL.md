...
6. Update `references/lei-investment-principles.md` in Chinese by merging the new evidence into existing principles instead of appending disconnected notes.
